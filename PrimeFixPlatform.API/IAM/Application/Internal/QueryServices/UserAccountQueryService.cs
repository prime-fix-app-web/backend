...
: IUserAccountQueryService
{
    ...
    {
        return await userAccountRepository.FindByIdAsync(query.IdUserAccount)
            ?? throw new NotFoundIdException("UserAccount with the id " + query.IdUserAccount + " was not found.");
    }
}