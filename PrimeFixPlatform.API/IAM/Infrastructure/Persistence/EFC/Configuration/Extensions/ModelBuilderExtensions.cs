...
public static class ModelBuilderExtensions
{
    ...
    public static void ApplyIamConfiguration(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().Property(u => u.UserId).IsRequired().HasMaxLength(255);
        ...
        modelBuilder.Entity<User>().Property(u => u.LocationId).IsRequired().HasMaxLength(255);

        modelBuilder.Entity<UserAccount>().HasKey(ua => ua.UserAccountId);
        modelBuilder.Entity<UserAccount>().Property(ua => ua.UserAccountId).IsRequired().HasMaxLength(255);
        ...
        modelBuilder.Entity<UserAccount>().Property(ua => ua.RoleId).IsRequired().HasMaxLength(255);
        modelBuilder.Entity<UserAccount>().Property(ua => ua.RoleId).IsRequired().HasMaxLength(255);
        ...
        modelBuilder.Entity<Role>().Property(r => r.RoleId).IsRequired().HasMaxLength(255);
        modelBuilder.Entity<Role>().OwnsOne(r => r.RoleInformation, ri =>
        {
            ri.WithOwner().HasForeignKey("RoleIdRole");
            ri.Property<int>("RoleIdRole").HasColumnName("id_role");
        ...
        modelBuilder.Entity<Membership>().Property(m => m.MembershipId).IsRequired().HasMaxLength(255);
