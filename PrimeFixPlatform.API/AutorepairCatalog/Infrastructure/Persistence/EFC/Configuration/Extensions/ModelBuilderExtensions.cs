...
public static class ModelBuilderExtensions
{
    ...
    public static void ApplyAutorepairCatalogConfiguration(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AutoRepair>().Property(ar => ar.AutoRepairId).IsRequired().HasMaxLength(255);
        ...
        modelBuilder.Entity<Location>().Property(l => l.LocationId).IsRequired().HasMaxLength(255);
